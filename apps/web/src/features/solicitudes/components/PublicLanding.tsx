...
<nav aria-label="Navegación principal"><a className="nav-brand" href="#inicio"><img className="brand-symbol" src="/brand/hogaria-isotipo.png" alt="" /><img className="brand-wordmark" src="/brand/hogaria-wordmark.png" alt="Hogaria Reformas Integrales" /></a><div className="nav-links"><a href="#obras">Obras</a><a href="#servicios">Servicios</a><a href="#proceso">Proyecto</a><a href="#contacto">Contacto</a></div><button type="button" className="private-access" onClick={onLogin}>Área privada</button></nav>
    ...
    <footer><a className="footer-brand" href="#inicio" aria-label="Hogaria, volver al inicio"><img src="/brand/hogaria-isotipo.png" alt="" /><img src="/brand/hogaria-wordmark.png" alt="Hogaria Reformas Integrales" /></a><p>Reformas integrales e interiorismo.<br />Madrid · 2026</p><div className="footer-contact"><a href="tel:+34614786341">+34 614 786 341</a><a href="mailto:info@hogaria.design">info@hogaria.design</a></div><div className="footer-links"><a className="footer-instagram" href="https://www.instagram.com/" target="_blank" rel="noreferrer" aria-label="Instagram de Hogaria"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></a><a href="#/privacidad">Privacidad</a><button onClick={onLogin}>Área cliente</button></div></footer>
  </div>;
}
